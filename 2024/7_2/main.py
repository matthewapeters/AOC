...
Three operators (||, + and *) are expected to be used with test data to produce the expected test result.
If they can, then the expected test result is added to the final value.  The || operator concatenates its
arguments, such that 10 || 12 would be 1012.
