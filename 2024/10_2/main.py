...
* trail heads are scored by the number of different paths they produce that
  reach a peak.  This is probably a minor change to part 1 -- don't de-dupe
...
if __name__ == "__main__":
    ...
    trails: Dict[Tuple[int, int], int] = {
        (x, y): len([peek for peek in hike(start=(x, y), topo_map=topo)])
